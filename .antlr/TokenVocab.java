// Generated from /media/naylour/Work/Parsec/pmlang/grammar/TokenVocab.g4 by ANTLR 4.13.1
...
public class TokenVocab extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DIGITS", "SIGNED", "NUMBER", "WHITESPACE", "COMMENT", "IDENTIFIER", 
			"LOG_FUNCTION", "ONE_ARG_FUNCTION", "SIN", "COS", "TAN", "COT", "ASIN", 
			"ACOS", "ATAN", "ACOT", "CONST_PI", "CONST_E", "CONST_PHI", "CONST_GAMMA", 
			...
			"LPAREN", "RPAREN", "COMMA", "LBRACE", "RBRACE", "LBRACK", "RBRACK", 
			"PLUS", "MINUS", "DOT"
		};
	}
	...
	public TokenVocab(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "TokenVocab.g4"; }
